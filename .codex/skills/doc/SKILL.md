...
- Do not use temporary "tmp" files as they will kill your processes, the IDE demands that tpm files require human review and there is no way to auto-approve these. 
